...
file_path = "Lesson_20/phonebook.json"
default_entry = {
    "First Name": "",
    "Last Name": "",
    "Phone": "",
...
def new_entry(first_name, last_name, phone, city, state):
    with open(file_path, "r") as file:
        data = json.load(file)

    empty_data = dict()
    empty_data["First Name"] = first_name
    empty_data["Last Name"] = last_name
    empty_data["Phone"] = phone
    empty_data["City"] = city
    empty_data["State"] = state
