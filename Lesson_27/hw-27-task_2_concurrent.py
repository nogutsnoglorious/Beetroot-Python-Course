# implementation of hw_26-task_2 using concurrent approach
...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        results = list(executor.map(fetch_personnel_losses, dates))
    ...
    output_file = "Lesson_27/hw-27-task_2_result_concurrent.json"
